...
<style>
  ...
  .poster-preview { max-width: 200px; max-height: 200px; border-radius: var(--radius-md); object-fit: cover; }
  ...
  .btn-select-poster:hover { background: var(--accent-light); transform: translateY(-1px); }
